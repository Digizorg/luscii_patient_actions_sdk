...
### Added
- Added support for logging out and clearing the iOS SDK session.
...
### Changed
- Bumped package and podspec version to `0.10.0`.
- Updated platform interface dependency constraint to `^0.10.0`.
