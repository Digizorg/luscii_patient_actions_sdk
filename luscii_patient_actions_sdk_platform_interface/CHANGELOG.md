...
### Added
- Added the `logout` method to the platform interface.
...
### Changed
- Bumped version to `0.10.1+1` to align with the federated package release.

## [0.10.0+1] - 2026-05-12

### Changed
- Bumped version to `0.10.0+1` to align with the federated package release.

## [0.9.0+1] - 2026-03-23

### Changed
- Bumped version to 0.9.0+1 to align with the main package release.
